...
{
    OMATH_CONSTEXPR Vector2<float> v;
...
{
    OMATH_CONSTEXPR Vector2 v(1.0f, 2.0f);
...
{
    OMATH_CONSTEXPR Vector2 v3(1.0f, 2.0f);
    EXPECT_TRUE(v1 == v3);
    EXPECT_FALSE(v1 == v2);
}
...
{
    OMATH_CONSTEXPR Vector2 v3 = Vector2(1.0f, 2.0f) + Vector2(4.0f, 5.0f);
...
{
    OMATH_CONSTEXPR Vector2 v3 = Vector2(4.0f, 5.0f) - Vector2(1.0f, 2.0f);
...
{
    OMATH_CONSTEXPR Vector2 v3 = Vector2(1.0f, 2.0f) * 2.0f;
...
{
    OMATH_CONSTEXPR Vector2 v3 = Vector2(4.0f, 5.0f) / 2.0f;
    EXPECT_FLOAT_EQ(v3.x, 2.0f);
...
{
    OMATH_CONSTEXPR Vector2 v3 = -Vector2(1.0f, 2.0f);
...
{
    OMATH_CONSTEXPR float distSqr = Vector2(1.0f, 2.0f).DistToSqr(Vector2(4.0f, 5.0f));
    EXPECT_FLOAT_EQ(distSqr, 18.0f);
}

TEST_F(UnitTestVector2, DistToSqr_SamePoint)
{
    OMATH_CONSTEXPR float distSqr = Vector2(1.0f, 2.0f).DistToSqr(Vector2(1.0f, 2.0f));
    EXPECT_FLOAT_EQ(distSqr, 0.0f);
}

TEST_F(UnitTestVector2, DotProduct)
{
    OMATH_CONSTEXPR float dot = Vector2(1.0f, 2.0f).Dot(Vector2(4.0f, 5.0f));
    EXPECT_FLOAT_EQ(dot, 14.0f);
}

TEST_F(UnitTestVector2, DotProduct_PerpendicularVectors)
{
    OMATH_CONSTEXPR float dot = Vector2(1.0f, 0.0f).Dot(Vector2(0.0f, 1.0f));
    EXPECT_FLOAT_EQ(dot, 0.0f);
}

TEST_F(UnitTestVector2, DotProduct_ParallelVectors)
{
    OMATH_CONSTEXPR float dot = Vector2(1.0f, 1.0f).Dot(Vector2(2.0f, 2.0f));
...
{
    OMATH_CONSTEXPR Vector2 v_zero(0.0f, 0.0f);
...
{
    OMATH_CONSTEXPR Vector2 v_large(FLT_MAX, FLT_MAX);
...
{
    OMATH_CONSTEXPR float lengthSqr = Vector2(1.0f, 2.0f).LengthSqr();
...
{
    OMATH_CONSTEXPR float sum = Vector2(1.0f, 2.0f).Sum();
...
{
    Vector2 v(1.0f, 2.0f);
    OMATH_CONSTEXPR Vector2 v_zero(0.0f, 1.0f);
    v /= v_zero;
    EXPECT_TRUE(std::isinf(v.x) || std::isnan(v.x));
...
{
    OMATH_CONSTEXPR Vector2 v_inf(INFINITY, INFINITY);
...
{
    OMATH_CONSTEXPR Vector2 v_nan(NAN, NAN);
...
{
    OMATH_CONSTEXPR Vector2 v_neg(-1.0f, -2.0f);
...
OMATH_STATIC_ASSERT(Vector2(1.0f, 2.0f).LengthSqr() == 5.0f, "LengthSqr should be 5");
OMATH_STATIC_ASSERT(Vector2(1.0f, 2.0f).Dot(Vector2(4.0f, 5.0f)) == 14.0f, "Dot product should be 14");
OMATH_STATIC_ASSERT(Vector2(4.0f, 5.0f).DistToSqr(Vector2(1.0f, 2.0f)) == 18.0f, "DistToSqr should be 18");
OMATH_STATIC_ASSERT(Vector2(-1.0f, -2.0f).Abs() == Vector2(1.0f, 2.0f), "Abs should convert negative values to positive");
